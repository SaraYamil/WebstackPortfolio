                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                ...
                                <div className="menu-info d-flex flex-wrap align-items-center">
                                    <h4 className="mb-0">Moroccan Trio</h4>

                                    <span className="price-tag bg-white shadow-lg ms-4">78&nbsp;<small>MAD</small></span>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                ...
                                <div className="menu-info d-flex flex-wrap align-items-center">
                                    <h4 className="mb-0">Refissa</h4>

                                    <span className="price-tag bg-white shadow-lg ms-4">278&nbsp;<small>MAD</small></span>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                ...
                                <div className="menu-info d-flex flex-wrap align-items-center">
                                    <h4 className="mb-0">Seffa</h4>

                                    <span className="price-tag bg-white shadow-lg ms-4">120&nbsp;<small>MAD</small></span>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                ...
                                <div className="menu-info d-flex flex-wrap align-items-center">
                                    <h4 className="mb-0">Kebab</h4>

                                    <span className="price-tag bg-white shadow-lg ms-4">150&nbsp;<small>MAD</small></span>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                ...
                                <div className="menu-info d-flex flex-wrap align-items-center">
                                    <h4 className="mb-0">Sfenj Donuts</h4>

                                    <span className="price-tag bg-white shadow-lg ms-4">36&nbsp;<small>MAD</small></span>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                ...
                                <div className="menu-info d-flex flex-wrap align-items-center">
                                    <h4 className="mb-0">Couscous</h4>

                                    <span className="price-tag bg-white shadow-lg ms-4">145&nbsp;<small>MAD</small></span>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="news-thumb mb-4">
                                ...
                                <div className="news-text-info">
                                    <span className="category-tag me-3 bg-info">Chef's Recipe</span>

                                    <strong>26 March 2024</strong>

                                    <h5 className="news-title mt-2">
                                        <a href="news-detail3.html" className="news-title-link">Bissara perfection tip: Flavor with finesse</a>
                                    </h5>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="news-thumb mb-4">
                                ...
                                <div className="news-text-info">
                                    ...
                                    <h5 className="news-title mt-2">
                                        <a href="news-detail1.html" className="news-title-link">Varied Ftour Ramadan buffet at only 249dh</a>
                                    </h5>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="news-thumb mb-4">
                                ...
                                <div className="news-text-info">
                                    ...
                                    <h5 className="news-title mt-2">
                                        <a href="news-detail2.html" className="news-title-link">Birthday with a Moroccan touch</a>
                                    </h5>
                                </div>
                            </div> 
                        </div>
